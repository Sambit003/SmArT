...
class App:
    def __init__(self):
        ...
        self.login_button_main_window = util.get_button(self.main_window, 'Validate', 'green', self.login, fg='black')
    ...
    def login(self):
        ...
        if name in ['unknown_person', 'no_persons_found']:
            util.msg_box('Oops....', 'Unknown Student, Please register new student or try again!')
        else:
    ...
    def accept_register_new_user(self):
        ...
        util.msg_box('Success!', 'Student Registered Successfully!')
